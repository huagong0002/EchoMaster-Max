            ...
            {user && (
              <div className="flex items-center gap-3 glass px-4 py-2 rounded-2xl border-blue-500/10">
                <div className="hidden lg:flex flex-col text-right">
                  <span className="text-xs font-bold text-white tracking-tight">{user.username}</span>
                  <button 
                        ...
                        <div>
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              setMaterials(prev => prev.map(item => item.id === m.id ? { ...item, title: newTitle } : item));
                            }}
                          ...
                          <div className="flex items-center gap-3 mt-2 text-xs text-slate-500 font-medium">
                            ...
                            <span className="flex items-center gap-1"><Calendar size={12} /> {new Date(m.lastModified).toLocaleDateString()}</span>
                          </div>
                        </div>
